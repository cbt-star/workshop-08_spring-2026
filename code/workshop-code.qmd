...
# create new object to from original data frame
drought_exp_clean <- drought_exp |> 
  # make column names lowercase with underscores
  clean_names() |> 
  # create new column to store binomial species names
  ...
  # create new column with full names for water treatment
...
slice_sample(
  ...
  n = 10 # select 10 rows from data frame
)
```
